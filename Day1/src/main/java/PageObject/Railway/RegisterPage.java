...
public class RegisterPage extends GeneralPage {
    ...
    public final By lblErrorEmailMsg=By.xpath("//label[normalize-space()='Invalid email address']");
    ...
    public WebElement getLabelDontMacthMsg() {
        return Constant.WEBDRIVER.findElement(lblErrorDontMatchMsg);
    }
    ...
    public String getErrorDontMatchMsg() {
        return getLabelDontMacthMsg().getText();
    }
